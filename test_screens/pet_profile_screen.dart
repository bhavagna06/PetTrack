...
class _PetProfileScreenState extends State<PetProfileScreen> {
    ...
    return Container(
      ...
      child: BottomNavigationBar(
        ...
        items: [
          ...
          _buildNavItem('assets/icons/plus_square_fill.svg', 'Post Lost', 1),
          _buildNavItem(
            'assets/icons/plus_square_regular.svg',
            'Post Found',
            2,
          ),
          _buildNavItem('assets/icons/search.svg', 'Search', 3),
  ...
  BottomNavigationBarItem _buildNavItem(
    ...
    final bool isSelected = index == _bottomNavIndex;
